...
const translations = {
  en: {
    ...
    schedule: 'Schedule',
    toolsLvgl: 'Tools / LVGL image/font converter',
    chat: 'Chat',
    mail: 'Mail',
  ...
  es: {
    ...
    schedule: 'Agenda',
    toolsLvgl: 'Herramientas / convertidor de imagen/fuente LVGL',
    chat: 'Chat',
    mail: 'Correo',
    walletManagement: 'Gestion de cartera',
    databaseManagement: 'Gestion de base de datos',
